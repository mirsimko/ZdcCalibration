...
zdcTree::zdcTree(TTree *tree, int tofCut)
{
  ...
  if (tree == 0) {
    ...
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/direct/star+u/msimko/ZDC/ZDC_Calibration/run16.ZdcCalibration.msimko/histo/run_17171009.histo.root");
    if (!f) {
      ...
      f = new TFile("/direct/star+u/msimko/ZDC/ZDC_Calibration/run16.ZdcCalibration.msimko/histo/run_17171009.histo.root");// xuyifei
    }
